...
| `limitControl[]`   | **empty**          |
| `lineNumber`       | **copy**           |
| `numberOfBonusBuy` | `bonusBuyNumber`   |
...
- [x] `buy.field9` จาก mechanic — lookup `mechanic-lookup.json` · ไม่เจอ/null → `1`
- [x] `get.getQuantity` จาก mechanic — lookup `mechanic-lookup.json` · ไม่เจอ/null → `1`
- [x] `get` **ไม่มี** `field8`
...
| Golden test                    | เทสเทียบ fixture `constants/fixtures/D001/` ยังไม่ครบ 7 เคส |
